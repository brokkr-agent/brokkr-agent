#!/usr/bin/osascript
-- list-week.scpt
-- Lists all calendar events for the next 7 days from Calendar.app
--
-- Usage:
--   osascript list-week.scpt
--
-- Output format:
...
try
    -- Set date range to this week (today midnight to 7 days from now 23:59:59)
    set queryStartDate to current date
    set time of queryStartDate to 0
    set queryEndDate to queryStartDate + (7 * days)
