...
-- Deletes a reminder from Reminders.app by ID
--
-- Usage:
--   osascript delete-reminder.scpt '{"id":"x-apple-reminder://..."}'
--
-- Required parameters:
--   id - Reminder ID to delete
--
-- Output format:
-- {"success": true, "data": {"id": "...", "deleted": true}, "error": null}

on run argv
    -- Check for arguments
    if (count of argv) < 1 then
        return "{\"success\": false, \"data\": null, \"error\": \"Missing required JSON argument. Usage: osascript delete-reminder.scpt '{\\\"id\\\":\\\"x-apple-reminder://...\\\"}'}\"}"
    end if
    ...
    try
        ...
        tell application "Reminders"
            ...
            set resultJSON to "{\"success\": true, \"data\": {\"id\": \"" & my escapeJSONString(reminderId) & "\", \"deleted\": true}, \"error\": null}"
